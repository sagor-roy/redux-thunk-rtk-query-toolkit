                ...
                <tbody className="divide-y divide-gray-300/20" id="lws-previewBooked">
                    {data.map((item, index) => (
                        <tr key={index} className="lws-bookedTable text-black">
                            ...
                            <td className="px-6 py-4 text-center">
                                <p className="lws-bookedGustes">{item.guests} Persons</p>
                            </td>
                            <td className="px-6 py-4 text-center">
                                <span className="lws-bookedClass"> {item.classes} </span>
                            </td>
                            <td className="px-6 py-4 text-center">
                    ...
                    {data.length === 0 && (
                        <tr>
                            <td colSpan={6} style={{ textAlign: 'center', padding: '20px', color: '#b5b5b5' }}>You haven't Flight Booked</td>
                        </tr>
                    )}
                </tbody>
            </table>
